<?php /* Smarty version Smarty-3.0.8, created on 2013-07-11 23:20:08
         compiled from "D:/xampp/htdocs/Local_Photowall/View\third_person_album/third_person_opened_album.html" */ ?>
<?php /*%%SmartyHeaderCode:3203451df3da827d9b5-95064461%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5110502a3d9995bf37f3a027531c15fcef9bb29e' => 
    array (
      0 => 'D:/xampp/htdocs/Local_Photowall/View\\third_person_album/third_person_opened_album.html',
      1 => 1373584804,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3203451df3da827d9b5-95064461',
  'function' => 
  array (
  ),
...
')"><span class="text-error"><strong>&nbsp;&nbsp;+取消关注&nbsp;</strong></span></button></p>
    ...
    <div class="list">
    	<input type="hidden" id="photo_amount" value="<?php echo $_smarty_tpl->getVariable('photo_number')->value;?>
"  />
    	<div class="album-path"><h3>我的相册 <i class="icon-arrow-right"></i><?php echo $_smarty_tpl->getVariable('album_name')->value;?>
（<?php echo $_smarty_tpl->getVariable('photo_number')->value;?>
张照片）</h3></div>
        <br/>
        <input type="hidden" name="all_photo_names" value="<?php echo $_smarty_tpl->getVariable('all_photo_name')->value;?>
" id="all_photo_names" />
        <input type="hidden" name="all_photo_ids" value="<?php echo $_smarty_tpl->getVariable('all_photo_id')->value;?>
" id="all_photo_ids" />
        <hr class="hr"/>
    	<ul>
            <!-- <li class="user_info">
...
","<?php echo $_smarty_tpl->getVariable('photo_2d_array')->value[$_smarty_tpl->getVariable('smarty')->value['section']['photo']['index']]['can_comment'];?>
","<?php echo $_smarty_tpl->getVariable('photo_number')->value;?>
")'>
