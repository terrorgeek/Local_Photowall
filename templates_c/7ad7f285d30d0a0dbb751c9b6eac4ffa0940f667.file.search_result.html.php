<?php /* Smarty version Smarty-3.0.8, created on 2013-07-15 14:21:09
         compiled from "D:/xampp/htdocs/Local_Photowall/View\home/search_result.html" */ ?>
<?php /*%%SmartyHeaderCode:2762251e40555296742-86584946%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '2762251e40555296742-86584946',
  'function' => 
  array (
  ),
          ...
          <li class="search_result_single row-fluid">
                ...
                <div class="span3 no-space">
                    <div class="img-display-large img-polaroid" onclick=''>
                        <a href="../third_person_album/third_person_show_album.php?user_id=<?php echo $_smarty_tpl->getVariable('Final_ResultSet')->value[$_smarty_tpl->getVariable('smarty')->value['section']['index']['index']]['user_id'];?>
" 
                        class="no-link img-large" style="background-image: url(<?php echo $_smarty_tpl->getVariable('Final_ResultSet')->value[$_smarty_tpl->getVariable('smarty')->value['section']['index']['index']]['photo_path'];?>
);"></a>
                    </div>
                ...
                <div class="span2 no-space">
                    ...
                    <?php if ($_smarty_tpl->getVariable('Final_ResultSet')->value[$_smarty_tpl->getVariable('smarty')->value['section']['index']['index']]['flag']=='myfans'){?>
                       <button type="button" class="btn btn-small" onclick="add_to_concern('<?php echo $_smarty_tpl->getVariable('Final_ResultSet')->value[$_smarty_tpl->getVariable('smarty')->value['section']['index']['index']]['user_id'];?>
',this)"><span class="text-error"><strong>&nbsp;&nbsp;+加关注&nbsp;</strong></span></button>
                    <?php }elseif($_smarty_tpl->getVariable('Final_ResultSet')->value[$_smarty_tpl->getVariable('smarty')->value['section']['index']['index']]['flag']=='myfriends'){?>
                       <button type="button" class="btn btn-small" onclick="cancel_concern('<?php echo $_smarty_tpl->getVariable('Final_ResultSet')->value[$_smarty_tpl->getVariable('smarty')->value['section']['index']['index']]['user_id'];?>
',this)"><span class="text-error"><strong>&nbsp;&nbsp;+取消关注&nbsp;</strong></span></button>
                    <?php }elseif($_smarty_tpl->getVariable('Final_ResultSet')->value[$_smarty_tpl->getVariable('smarty')->value['section']['index']['index']]['flag']=='myconcerns'){?>
                       <button type="button" class="btn btn-small" onclick="cancel_concern('<?php echo $_smarty_tpl->getVariable('Final_ResultSet')->value[$_smarty_tpl->getVariable('smarty')->value['section']['index']['index']]['user_id'];?>
',this)"><span class="text-error"><strong>&nbsp;&nbsp;+取消关注&nbsp;</strong></span></button>
                    <?php }elseif($_smarty_tpl->getVariable('Final_ResultSet')->value[$_smarty_tpl->getVariable('smarty')->value['section']['index']['index']]['flag']=='none'){?>
                       <button type="button" class="btn btn-small" onclick="add_to_concern('<?php echo $_smarty_tpl->getVariable('Final_ResultSet')->value[$_smarty_tpl->getVariable('smarty')->value['section']['index']['index']]['user_id'];?>
',this)"><span class="text-error"><strong>&nbsp;&nbsp;+加关注&nbsp;</strong></span></button>
                    <?php }?>
                </div>
