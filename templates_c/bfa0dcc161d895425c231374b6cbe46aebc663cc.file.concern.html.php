<?php /* Smarty version Smarty-3.0.8, created on 2013-07-10 15:22:21
         compiled from "D:/xampp/htdocs/Local_Photowall/View\relation/concern.html" */ ?>
<?php /*%%SmartyHeaderCode:2500751dd7c2d317891-25429880%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bfa0dcc161d895425c231374b6cbe46aebc663cc' => 
    array (
      0 => 'D:/xampp/htdocs/Local_Photowall/View\\relation/concern.html',
      1 => 1373469355,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2500751dd7c2d317891-25429880',
  'function' => 
  array (
  ),
...
<div class="wrapper">
    <div class="header">
        ...
        <div id="nav_bar">
            <div class="banner">
                <div id="page_name"><p>我的关注</p><br /><p>MY CONCERNS</p></div>
 ...
 $_from = $_smarty_tpl->getVariable('concerns_array')->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>
    <?php if ($_smarty_tpl->getVariable('concerns_array')->value[$_smarty_tpl->tpl_vars['k']->value]['first_letter']!=$_smarty_tpl->getVariable('letter_storage')->value[$_smarty_tpl->tpl_vars['k']->value]){?> 
    <div class="list" id="letter_<?php echo $_smarty_tpl->getVariable('concerns_array')->value[$_smarty_tpl->tpl_vars['k']->value]['first_letter'];?>
">
    	<div class="tag"><h3><?php echo $_smarty_tpl->getVariable('concerns_array')->value[$_smarty_tpl->tpl_vars['k']->value]['first_letter'];?>
</h3></div>
...
" height="117" width="151" />
          ...
          -->
                    <p onclick="window.location='http://google.com' "><?php echo $_smarty_tpl->getVariable('concerns_array')->value[$_smarty_tpl->tpl_vars['k']->value]['nick_name'];?>
</p>
                    <div class="list_action hideV">
                    	<div class="list_action_button" onclick="visit_this(<?php echo $_smarty_tpl->getVariable('concerns_array')->value[$_smarty_tpl->tpl_vars['k']->value]['user_id'];?>
)">
                        	<p>访问</p>
                        </div>
						<div class="list_action_button" onclick="delete_this(<?php echo $_smarty_tpl->getVariable('concerns_array')->value[$_smarty_tpl->tpl_vars['k']->value]['user_id'];?>
);">
                        	<p>删除</p>
                        </div>                    
                    </div>
...
" height="117" width="151" />
    ...
    <?php }?>
    <?php if ($_smarty_tpl->getVariable('concerns_array')->value[$_smarty_tpl->tpl_vars['k']->value+1]['first_letter']!=$_smarty_tpl->getVariable('letter_storage')->value[$_smarty_tpl->tpl_vars['k']->value+1]){?> 
        </ul>
    </div>
    <?php }?>
    <?php }} ?>
