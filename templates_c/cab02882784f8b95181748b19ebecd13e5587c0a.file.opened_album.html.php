<?php /* Smarty version Smarty-3.0.8, created on 2013-07-11 23:13:32
         compiled from "D:/xampp/htdocs/Local_Photowall/View\album/opened_album.html" */ ?>
<?php /*%%SmartyHeaderCode:3273351df3c1c583eb1-72330888%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '3273351df3c1c583eb1-72330888',
  'function' => 
  array (
  ),
...
<div class="wrapper">
    ...
    <div class="list">
    	<input type="hidden" id="photo_amount" value="<?php echo $_smarty_tpl->getVariable('photo_amount')->value;?>
"  />
    	<div class="album-path"><h3>我的相册 <i class="icon-arrow-right"></i><?php echo $_smarty_tpl->getVariable('album_name')->value;?>
</h3></div>
    	<input type="hidden" name="all_photo_names" value="<?php echo $_smarty_tpl->getVariable('all_photo_names')->value;?>
" id="all_photo_names" />
        <input type="hidden" name="all_photo_ids" value="<?php echo $_smarty_tpl->getVariable('all_photo_ids')->value;?>
" id="all_photo_ids" />
...
?>
            <li class="user_info">
               <div class="img-display-large img-polaroid" onclick='see_single_photo("<?php echo $_smarty_tpl->getVariable('photo_2d_array')->value[$_smarty_tpl->getVariable('smarty')->value['section']['photo']['index']]['photo_id'];?>
","<?php echo $_smarty_tpl->getVariable('photo_2d_array')->value[$_smarty_tpl->getVariable('smarty')->value['section']['photo']['index']]['photo_name'];?>
","<?php echo $_smarty_tpl->getVariable('photo_amount')->value;?>
")'>
                    <a href="#myModal" class="no-link img-large" data-toggle="modal" style="background-image: url(<?php echo $_smarty_tpl->getVariable('photo_2d_array')->value[$_smarty_tpl->getVariable('smarty')->value['section']['photo']['index']]['photo_path_display'];?>
);">
...
" class="img-polaroid img-large"/> -->
                ...
                <div class="list_action hideV">
                    ...
                    <div class="list_action_button" onclick="delete_photo_from_DB('<?php echo $_smarty_tpl->getVariable('photo_2d_array')->value[$_smarty_tpl->getVariable('smarty')->value['section']['photo']['index']]['photo_id'];?>
','<?php echo $_smarty_tpl->getVariable('photo_2d_array')->value[$_smarty_tpl->getVariable('smarty')->value['section']['photo']['index']]['photo_name'];?>
')" >
                        <p>删除</p>
                    </div>
